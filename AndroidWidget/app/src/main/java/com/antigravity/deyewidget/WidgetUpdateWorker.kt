    ...
    private fun updateUI(context: Context, appWidgetManager: AppWidgetManager, appWidgetIds: IntArray, data: JSONObject?, success: Boolean) {
        ...
        for (appWidgetId in appWidgetIds) {
            ...
            if (success && data != null) {
                ...
                views.setTextViewText(R.id.tv_grid, "Hálózat: ${data.optInt("grid_power_external", 0)} W")
                ...
                views.setTextViewText(R.id.tv_ups, "Ház: ${data.optInt("ups_load", 0)} W")
                views.setTextViewText(R.id.tv_charger, "Autó töltés: ${data.optInt("charger_current", 0)} W")
            } else {
